...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_pricing_block_tiers_cta_variant" AS ENUM('default', 'outline', 'cta');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_pricing_block_tiers_cta_variant" AS ENUM('default', 'outline', 'cta');
  ...
  CREATE TABLE "pages_blocks_pricing_block_tiers_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "pages_blocks_pricing_block_tiers" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  	...
  	"cta_label" varchar,
  	"cta_url" varchar,
  	"cta_variant" "enum_pages_blocks_pricing_block_tiers_cta_variant" DEFAULT 'default'
  );
  
  CREATE TABLE "pages_blocks_pricing_block_trust_badges" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"value" varchar,
  ...
  CREATE TABLE "pages_blocks_pricing_block" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Flexible access for every stage of growth.',
  	"subtitle" varchar DEFAULT 'Start with the plan that fits your current workload, then expand model access and operational controls as your application grows.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_pricing_block_tiers_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_pricing_block_tiers" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	...
  	"cta_label" varchar,
  	"cta_url" varchar,
  	"cta_variant" "enum__pages_v_blocks_pricing_block_tiers_cta_variant" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_pricing_block_trust_badges" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"value" varchar,
  ...
  ALTER TABLE "pages_blocks_pricing_block_tiers_features" ADD CONSTRAINT "pages_blocks_pricing_block_tiers_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pricing_block_tiers"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_pricing_block_tiers" ADD CONSTRAINT "pages_blocks_pricing_block_tiers_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_pricing_block_trust_badges" ADD CONSTRAINT "pages_blocks_pricing_block_trust_badges_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_pricing_block_tiers_features" ADD CONSTRAINT "_pages_v_blocks_pricing_block_tiers_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pricing_block_tiers"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_pricing_block_tiers" ADD CONSTRAINT "_pages_v_blocks_pricing_block_tiers_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_pricing_block_trust_badges" ADD CONSTRAINT "_pages_v_blocks_pricing_block_trust_badges_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_pricing_block_tiers_features_order_idx" ON "pages_blocks_pricing_block_tiers_features" USING btree ("_order");
  CREATE INDEX "pages_blocks_pricing_block_tiers_features_parent_id_idx" ON "pages_blocks_pricing_block_tiers_features" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_pricing_block_tiers_order_idx" ON "pages_blocks_pricing_block_tiers" USING btree ("_order");
  CREATE INDEX "pages_blocks_pricing_block_tiers_parent_id_idx" ON "pages_blocks_pricing_block_tiers" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_pricing_block_trust_badges_order_idx" ON "pages_blocks_pricing_block_trust_badges" USING btree ("_order");
  CREATE INDEX "pages_blocks_pricing_block_trust_badges_parent_id_idx" ON "pages_blocks_pricing_block_trust_badges" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_pricing_block_tiers_features_order_idx" ON "_pages_v_blocks_pricing_block_tiers_features" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_pricing_block_tiers_features_parent_id_idx" ON "_pages_v_blocks_pricing_block_tiers_features" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_pricing_block_tiers_order_idx" ON "_pages_v_blocks_pricing_block_tiers" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_pricing_block_tiers_parent_id_idx" ON "_pages_v_blocks_pricing_block_tiers" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_pricing_block_trust_badges_order_idx" ON "_pages_v_blocks_pricing_block_trust_badges" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_pricing_block_trust_badges_parent_id_idx" ON "_pages_v_blocks_pricing_block_trust_badges" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_pricing_block_tiers_features" CASCADE;
  DROP TABLE "pages_blocks_pricing_block_tiers" CASCADE;
  DROP TABLE "pages_blocks_pricing_block_trust_badges" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_pricing_block_tiers_features" CASCADE;
  DROP TABLE "_pages_v_blocks_pricing_block_tiers" CASCADE;
  DROP TABLE "_pages_v_blocks_pricing_block_trust_badges" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_pricing_block_tiers_cta_variant";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_pricing_block_tiers_cta_variant";
